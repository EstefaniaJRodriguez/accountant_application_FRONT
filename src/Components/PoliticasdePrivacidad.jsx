...
function Politicas() {
  return (
    <Container className="my-5">
      <h2 style={{ fontWeight: 'bold', fontSize: '28px', marginBottom: '20px' }}>Políticas de Privacidad</h2>
...
Todas las personas que visitan el sitio web de Bover Sandra Marcela y/o utilicen los servicios de Bover Sandra Marcela, prestan su conformidad a los términos informados en esta Politica. Aquel usuario que no estuviera de acuerdo, deberá abstenerse de utilizar los recursos y servicios de proporcionados por BOVER SANDRA MARCELA
        ...
        De la política de protección de datos de carácter personal de la página www.genimpositivo.com  propiedad de la Empresa.</p>
...
Se exonera a la Empresa de responsabilidad ante cualquier daño o perjuicio que pudiera sufrir el usuario como consecuencia de errores, defectos u omisiones de cualquier tipo por el uso de información facilitada por el Usuario en favor de la Empresa.
        ...
        <h4 style={{ fontWeight: 'bold', fontSize: '20px', marginTop: '25px' }}>6.- Derechos sobre los Datos Recopilados</h4>
        <p style={{ marginBottom: '20px' }}>
...
Sólo tendrá el carácter de obligatorio el suministro de datos siempre y cuando se proceda a contratar el SERVICIO y/o se contacte a la Empresa.
        ...
        <h4 style={{ fontWeight: 'bold', fontSize: '20px', marginTop: '25px' }}>7.2.- Uso de Cookies</h4>
        <p style={{ marginBottom: '20px' }}>
        Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso para almacenarse en su ordenador, al aceptar dicho fichero se crea y la cookie sirve entonces para tener información respecto al tráfico web, y también facilita las futuras visitas a una web recurrente. Otra función que tienen las cookies es que con ellas nuestro sitio web puede reconocerlo individualmente y por tanto brindarle el mejor servicio personalizado de su web. Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia. Esta información es empleada únicamente para análisis estadístico y después la información se elimina de forma permanente. Usted puede aceptar o negar el uso de cookies, sin embargo, la mayoría de los navegadores aceptan cookies automáticamente pues sirve para tener un mejor servicio web. Si se declinan es posible que no pueda utilizar algunos de nuestros servicios. Asimismo, Usted puede eliminar las cookies en cualquier momento desde su dispositivo, aunque esto puede afectar el funcionamiento de nuestros servicios.
        </p>

        <h4 style={{ fontWeight: 'bold', fontSize: '20px', marginTop: '25px' }}>7.3.- Pagos y Reembolsos</h4>
        <p style={{ marginBottom: '20px' }}>
...
El USUARIO declara ser consciente y entiende que la Empresa utiliza todos los conocimientos técnicos y organizativos a su alcance para evitar dichos percances. Sin perjuicio de ello, conforme el estado actual de la tecnología, dichos conocimientos y medidas no aseguran al %100 la seguridad de la información. En el ámbito digital, toda medida aplicada tiende a evitar la producción de daños, detectar amenazas y cubrir las vulnerabilidades. En caso de que se explote una vulnerabilidad, se procederá siempre de manera diligente y veloz para la eliminación/tratamiento del mismo.
        ...
        <h4 style={{ fontWeight: 'bold', fontSize: '20px', marginTop: '25px' }}>10.- Duración de Almacenamiento de la Clave Fiscal</h4>
        <p style={{ marginBottom: '20px' }}>
        En TODO supuesto y de conformidad al art. 25, Inc. II de la Ley 25.326, el dato de CLAVE FISCAL - el cual es facilitado por el USUARIO y es indispensable para poder prestar el servicio - siempre será DESTRUIDO Y CANCELADO de la base de datos de la Empresa inmediatamente luego de prestado el SERVICIO y terminada la relación jurídica con el USUARIO.
Bajo ningún concepto la Empresa retendrá dicho dato luego de prestado el SERVICIO.
Tampoco lo retendrá - jamás y en ninguna circunstancia - por un plazo mayor al de quince (15) días.

        </p>

        <h4 style={{ fontWeight: 'bold', fontSize: '20px', marginTop: '25px' }}>11.- Edad</h4>
        <p style={{ marginBottom: '20px' }}>
        A todos los efectos, la Empresa deja establecido por la presente que sus servicios solo son ofrecidos a mayores de dieciocho (18) años. Al aceptar la presente, el Usuario declara que es mayor a dicha edad.</p>

        <h4 style={{ fontWeight: 'bold', fontSize: '20px', marginTop: '25px' }}>12.- Legislación y Jurisdicción Aplicable</h4>
        <p style={{ marginBottom: '20px' }}>
          La Ley aplicable es la Ley Nº 25.326 y normas complementarias de la República Argentina. Las controversias se someterán a los tribunales ordinarios de Córdoba, Argentina.
        </p>

        <h4 style={{ fontWeight: 'bold', fontSize: '20px', marginTop: '25px' }}>12.- Aceptación y consentimiento</h4>
        <p style={{ marginBottom: '20px' }}>
        El USUARIO declara aquí haber sido informado de la política de protección de datos de carácter personal, aceptando y consintiendo al tratamiento automatizado de los mismos por parte de la Empresa, en la forma y para las finalidades aquí detallados.
Al momento de rellenar los formularios de la página web y facilitar sus datos de carácter personal como así también por cualquier otro medio, el USUARIO manifiesta haber leído y aceptado estas condiciones.
Amén de lo explicado anteriormente de índole general, el USUARIO expresa e inequívocamente consiente:
• Que recojamos y tratemos sus datos de carácter personal con arreglo a los fines aquí expresados.
• El tratamiento y transferencia de sus datos fuera del ámbito de la República Argentina, especialmente dentro de la Unión Europea por parte terceros encargados del alojamiento de nuestros servidores y/o gestión de base de datos.
• La recepción de correos electrónicos comerciales enviados por nosotros.
El tratamiento por parte de terceros de sus datos personales conforme a los fines aquí establecidos. 
 Si aún le quedan dudas puede escribirnos por correo electrónico a gen.impositivo@gmail.com o utilizar el formulario de contacto
        ...
        <h4 style={{ fontWeight: 'bold', fontSize: '20px', marginTop: '25px' }}>12.1.- Modificaciones a la Política</h4>
        <p style={{ marginBottom: '20px' }}>
        Bover Sandra Marcela se reserva el derecho de cambiar los términos de la presente Política en cualquier momento. Informaremos mediante una comunicación electrónica a nuestros usuarios registrados sobre cualquier modificación a esta Política, y de ser necesario se solicitará nuevamente su consentimiento. En caso de desacuerdo respecto de tales modificaciones, Usted deberá (i) para usuarios de nuestro sitio web no registrados: abstenerse de utilizar el sitio; (ii) para usuarios registrados y clientes de Bover Sandra Marcela: comunicarnos su NO aceptación, enviando un e-mail a gen.impositivo@gmail.com o en el formulario de contacto de www.genimpositivo.com desde su dirección de correo electrónico registrada, dentro de los diez (10) días corridos luego de la publicación de las modificaciones, en este supuesto se procederá a dar de baja su cuenta y condición de usuario/cliente y se considerará finalizada su relación con Bover Sandra Marcela. La falta de manifestación expresa de desacuerdo durante el plazo indicado será considerada una aceptación incondicional a la nueva Política modificada.
        </p>

        <h4 style={{ fontWeight: 'bold', fontSize: '20px', marginTop: '25px' }}>12.2.- ¿Qué ley es aplicable a esta Política de Privacidad?</h4>
        <p style={{ marginBottom: '20px' }}>
        Esta Política se encuentra regida para todas personas y en todos sus términos por las leyes y otras normas vigentes de la República Argentina y será interpretada de acuerdo con ellas. Cualquier controversia derivada de la presente Política, su existencia, validez, interpretación, alcance o cumplimiento será sometida a los tribunales ordinarios de Justicia con jurisdicción en Argentina, y tanto usted como Bover Sandra Marcela renuncia expresamente a cualquier otro fuero o jurisdicción.
