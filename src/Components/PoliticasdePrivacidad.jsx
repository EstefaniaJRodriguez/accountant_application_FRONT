...
Todas las personas que visitan el sitio web de Bover Sandra Marcela y/o utilicen los servicios de Bover Sandra Marcela, prestan su conformidad a los términos informados en esta Politica. Aquel usuario que no estuviera de acuerdo, deberá abstenerse de utilizar los recursos y servicios de proporcionados por BOVER SANDRA MARCELA
        ...
        <h4 className="subtitulo">2.- Derecho a la Información</h4>
        <p className="parrafo">
...
De la política de protección de datos de carácter personal de la página www.genimpositivo.com  propiedad de la Empresa.
        ...
        <h4 className="subtitulo">3.- Alojamiento Web</h4>
        <p className="parrafo">
        ...
        <h4 className="subtitulo">4.- COMUNICACIONES - FORMULARIOS WEB – INFORMACION RECOGIDA - REGISTRO DE BASE DE DATOS ANTE LA DIRECCIÓN NACIONAL DE PROTECCIÓN DE DATOS PERSONALES DE LA AGENCIA DE ACCESO A LA INFORMACIÓN PÚBLICA</h4>
        <p className="parrafo">
        ...
        <h4 className="subtitulo">4.1.- Información Recopilada</h4>
        <p className="parrafo">
        ...
        <h4 className="subtitulo">4.2.- Resguardo de los Datos</h4>
        <p className="parrafo">
...
Dicha base datos se consigna bajo el nombre “CLIENTES” y se encuentra debidamente inscripta en la Dirección Nacional de Protección de datos. 
        ...
        <h4 className="subtitulo">5.- Exactitud y Veracidad de los Datos</h4>
        <p className="parrafo">
...
Se exonera a la Empresa de responsabilidad ante cualquier daño o perjuicio que pudiera sufrir el usuario como consecuencia de errores, defectos u omisiones de cualquier tipo por el uso de información facilitada por el Usuario en favor de la Empresa.
        ...
        <h4 className="subtitulo">6.- Derechos sobre los Datos Recopilados</h4>
        <p className="parrafo">
        ...
        <h4 className="subtitulo">7.- Ejercicio de Derechos de acceso, actualización, rectificación y supresión de datos.</h4>
        <p className="parrafo">
...
En el sitio web de la DNPDP - AAIP (https://www.argentina.gob.ar/aaip/datospersonales/derechos) encontrará modelos para ejercer dichos derechos.
        ...
        <h4 className="subtitulo">7.1.- Uso de los Datos Personales</h4>
        <p className="parrafo">
...
Sólo tendrá el carácter de obligatorio el suministro de datos siempre y cuando se proceda a contratar el SERVICIO y/o se contacte a la Empresa.
        ...
        <h4 className="subtitulo">7.2.- Uso de Cookies</h4>
        <p className="parrafo">
        ...
        <h4 className="subtitulo">7.3.- Pagos y Reembolsos</h4>
        <p className="parrafo">
        ...
        <h4 className="subtitulo">8.- Cesión de Datos a Terceros</h4>
        <p className="parrafo">
...
Al momento de sanción de la presente, sólo cuenta con dicho acceso la empresa “BOVER SANDRA MARCELA - CUIT 27-16157893-8”, para lo cual Ud. - el Usuario - presta EXPRESO CONSENTIMIENTO para que revelemos a este tercero sus datos personales y documentación acompañada a los fines de que podamos llevar a cabo la prestación del servicio, para lo cual Ud. nos autoriza expresamente a revelarle a dicho tercero los datos sobre su caso que estimemos convenientes para poder llevar a cabo correctamente la prestación del Servicio
        ...
        <h4 className="subtitulo">9.- Medidas de Seguridad</h4>
        <p className="parrafo">
...
El USUARIO declara ser consciente y entiende que la Empresa utiliza todos los conocimientos técnicos y organizativos a su alcance para evitar dichos percances. Sin perjuicio de ello, conforme el estado actual de la tecnología, dichos conocimientos y medidas no aseguran al %100 la seguridad de la información. En el ámbito digital, toda medida aplicada tiende a evitar la producción de daños, detectar amenazas y cubrir las vulnerabilidades. En caso de que se explote una vulnerabilidad, se procederá siempre de manera diligente y veloz para la eliminación/tratamiento del mismo.
        ...
        <h4 className="subtitulo">10.- Duración de Almacenamiento de la Clave Fiscal</h4>
        <p className="parrafo">
...
Tampoco lo retendrá - jamás y en ninguna circunstancia - por un plazo mayor al de quince (15) días.
        ...
        <h4 className="subtitulo">11.- Edad</h4>
        <p className="parrafo">
          A todos los efectos, la Empresa deja establecido por la presente que sus servicios solo son ofrecidos a mayores de dieciocho (18) años. Al aceptar la presente, el Usuario declara que es mayor a dicha edad.
        </p>

        <h4 className="subtitulo">12.- Legislación y Jurisdicción Aplicable</h4>
        <p className="parrafo">
        ...
        <h4 className="subtitulo">12.- Aceptación y consentimiento</h4>
        <p className="parrafo">
...
Al momento de rellenar los formularios de la página web y facilitar sus datos de carácter personal como así también por cualquier otro medio, el USUARIO presta su consentimiento expreso para el almacenamiento y tratamiento de sus datos en los términos detallados en la presente política.
        </p>
